...
import com.greedy.newworker.jwt.JwtAccessDeniedHandler;
import com.greedy.newworker.jwt.JwtAuthenticationEntryPoint;
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		 ...
		 return http
		         ...
		         .and()
		             ...
		             .antMatchers("/app/approval/**").hasAnyRole("EMPLOYEE", "ADMIN")
		             .antMatchers("/emp/employee/Register").hasAnyRole("ADMIN")
