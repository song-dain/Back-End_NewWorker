...
public class CalendarService {
	...
	/* 일정 조회 */
	public List<CalendarDto> officeCalendar(EmployeeDto employee, Criteria category) {
	...
	public CalendarDto updateSchedule(EmployeeDto employee, Long calendarNo, CalendarDto schedule) {
		...
		updateSchedule.getCalendarCategory().setCalendarCategoryNo(schedule.getCalendarCategory().getCalendarCategoryNo());
		updateSchedule.getCalendarCategory().setCalendarCategoryName(schedule.getCalendarCategory().getCalendarCategoryName());
